...
export default function AboutPage() {
  return (
    <div className="w-full min-h-screen bg-[#FBFBFB]">
      <Navbar />
      <div className="w-full bg-[#FBFBFB] flex flex-col items-center justify-center mt-10 px-4 md:px-0">
        {/* Header */}
        ...
        {/* Intro Card */}
        <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6 md:p-8 max-w-3xl text-left text-gray-700 leading-relaxed mb-20">
          <p>
        ...
        {/* Cards Section */}
        <div className="flex flex-col gap-10 w-full max-w-4xl px-2 md:px-0">
          {/* Card 1 */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 text-left transition hover:shadow-md">
            <img src="/images/LP 1.png" alt="Education Illustration" className="w-32 md:w-40 object-contain" />
          ...
          {/* Card 2 */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 text-left transition hover:shadow-md">
            <img src="/images/LP 2.png" alt="Industrial Revolution" className="w-32 md:w-40 object-contain" />
            <p className="text-gray-700 leading-relaxed text-sm md:text-base">
          ...
          {/* Card 3 */}
          <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center md:items-start gap-6 text-left transition hover:shadow-md">
            <img src="/images/LP 3.png" alt="Modern Problems" className="w-32 md:w-40 object-contain" />
            <p className="text-gray-700 leading-relaxed text-sm md:text-base">
        ...
        {/* Final Section */}
        <h2 className="text-2xl md:text-3xl font-semibold mt-20 mb-10 text-center">Kemana tujuan kami?</h2>

        <div className="bg-white border border-gray-200 shadow-sm rounded-2xl p-6 md:p-8 max-w-3xl text-left text-gray-700 leading-relaxed mb-32">
          <p>
